...
초기 감사 단계에서는 애플리케이션 코드를 변경하지 않았다. 이후 작업은 아래
단계별로 진행하고, 각 단계가 독립적으로 검증 가능한 상태를 유지한다.
...
- 이동 전후 콘텐츠 파일: 1,037개로 동일
- 이동 전후 Markdown: 114개로 동일
- 상대경로와 파일 내용을 포함한 SHA-256 집계:
  `a4131e2def7913b1f8f9b07364ac2b5a9a3d6c0571bdbfd960830c170921d7a7`
- 생성 게시물 URL 목록 SHA-256 집계:
  `b077020c922c127e4d3266cae5b973efaf75540a9bb7299d77af6eebd304d3ca`
- 논리 게시물 112개, 번역 2개, 공개 경로 114개, 로컬 이미지 참조
  922개 유지
